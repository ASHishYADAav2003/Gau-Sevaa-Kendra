...
export default function AddAnimal() {
  ...
  const handleSave = () => {
    ...
    // Format date roughly like "18 May 2026"
      ...
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-800 flex items-center gap-2">
            Add New Animal <span className="text-gray-400 font-normal">/ नया पशु जोड़ें</span>
          </h2>
          <p className="text-sm text-gray-500 mt-1">Dashboard &gt; Animals &gt; Add New</p>
        </div>
      </div>
